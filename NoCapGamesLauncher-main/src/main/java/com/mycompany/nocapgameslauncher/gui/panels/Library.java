...
public class Library extends JPanel {
    ...
    public Library(mainFrame frame) {
        ...
        setBackground(ThemeManager.getMainBackground());
    ...
    private void createContentView() {
        try {
            ...
            titleLabel.setForeground(ThemeManager.getTitleColor());
            titleLabel.setHorizontalAlignment(SwingConstants.LEFT);
            add(titleLabel, BorderLayout.NORTH);

            cardsPanel = new JPanel(new GridLayout(0, 4, 20, 20));
            cardsPanel.setBackground(ThemeManager.getMainBackground());
            ...
            if (gameTitles.isEmpty()) {
                ...
                for (String title : gameTitles) {
                    ...
                    JPanel gameCard = GameCardCreator.createGameCard(title, "Description for " + title, gameIcon);
            ...
            cardsWrapper.setBackground(ThemeManager.getMainBackground());
