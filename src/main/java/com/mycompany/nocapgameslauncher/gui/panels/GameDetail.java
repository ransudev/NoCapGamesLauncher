...
public class GameDetail extends ThemePanel {
    ...
    public GameDetail(mainFrame frame) {
        ...
        gameDescriptionArea.setFont(new Font("Arial", Font.PLAIN, 18));
        ...
        playButton.setBackground(new Color(67, 160, 71)); // Steam Green
    ...
    public void setGame(String gameTitle) {
        ...
        updateTheme(); // Update theme after setting content
    }
