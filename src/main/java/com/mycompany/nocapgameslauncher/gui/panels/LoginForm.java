...
import com.mycompany.nocapgameslauncher.gui.utilities.AuthManager;
...
public class LoginForm extends JPanel {
    ...
    private void handleLogin(String username, String password) {
        ...
        try {
            boolean ok = AuthManager.login(username, password);
            if (ok) {
                // Open main frame and close login
    ...
    private void handleRegister(String username, String password, String confirm) {
        ...
        try {
            boolean created = AuthManager.register(username, password);
            if (created) {
